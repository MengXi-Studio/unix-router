...
| 🟢 **Core Features** | [Route Configuration](./route-config) → [Navigation](./navigation) → [Composables](./composables) | The route table and named routes, the four navigation modes and TabBar detection, useRouter / useRoute / useLink |
